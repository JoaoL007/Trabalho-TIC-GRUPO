    ...
    <main class="container">
        ...
        <section class="featured">
            <div class="featured-container">
                <div class="main-featured" onclick="window.location.href='noticia.php?id=1'">
                    ...
                    <div class="featured-content">
                        ...
                        <a href="noticia.php?id=1" class="btn">Ler Mais</a>
                    </div>
                </div>
                <div class="side-featured">
                    <div class="side-item" onclick="window.location.href='noticia.php?id=2'">
                    ...
                    <div class="side-item" onclick="window.location.href='noticia.php?id=3'">
                    ...
                    <div class="side-item" onclick="window.location.href='noticia.php?id=4'">
        ...
        <section class="news-section">
            <div class="section-header">
                ...
                <a href="noticias.php" class="btn">Ver Todas</a>
            </div>
            <div class="news-grid">
                <div class="news-card" onclick="window.location.href='noticia.php?id=5'">
                ...
                <div class="news-card" onclick="window.location.href='noticia.php?id=6'">
                ...
                <div class="news-card" onclick="window.location.href='noticia.php?id=7'">

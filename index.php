...
<body>
    ...
    <div class="top-bar">
        <div class="top-bar-container">
            ...
            right: 0;
            bottom: 0;
            background: url('data:image/svg+xml,<svg width="60" height="60" xmlns="http://www.w3.org/2000/svg">
                <defs>
                ...
                <section class="hero" id="home">
                    <div class="hero-container">
                        <div class="hero-content">
                            ...
                            <p>Cobertura completa sobre robótica, inteligência artificial e automação. Mantenha-se
                                atualizado com as
                        ...
                        <div class="testimonials-grid">
                            <div class="testimonial-card" data-aos="zoom-in">
                                ...
                                <p class="testimonial-text">
                                    O RoboNews é minha fonte principal para me manter atualizado sobre inovações em
                                    robótica.
                            ...
                            <div class="testimonial-card" data-aos="zoom-in" data-aos-delay="100">
                                <div class="quote-icon">"</div>
                                <p class="testimonial-text">
                                    Excelente portal! Artigos bem escritos e sempre atualizados com as últimas
                                    tendências em IA e
                                    robótica.
                                </p>
                                <div class="testimonial-author">
                            ...
                            <div class="testimonial-card" data-aos="zoom-in" data-aos-delay="200">
                                <div class="quote-icon">"</div>
                                <p class="testimonial-text">
                                    Conteúdo técnico acessível e bem explicado. Perfeito para quem trabalha ou estuda
                                    tecnologia!
                                </p>
                                <div class="testimonial-author">
                                    <div class="author-avatar">?????</div>
                ...
                <section class="stats-section">
                    <div class="container">
                        <div class="stats-header">
                            ...
                            <p class="stats-subtitle">Impactando a comunidade tecnológica com informação de qualidade
                            </p>
                        </div>
                    ...
                    anchor.addEventListener('click', function(e) {
                        ...
                        if (target) {
                            ...
                            if (navLinks.classList.contains('active')) {
                                ...
                                mobileMenuToggle.querySelector('i').classList.replace('fa-times',
                                    'fa-bars');
                            }
                        }
                    });
                    ...
                    searchInput.addEventListener('keypress', (e) => {
                        if (e.key === 'Enter' && searchInput.value.trim()) {
                            window.location.href =
                                `pages/noticias.php?search=${encodeURIComponent(searchInput.value)}`;
                        }
                    });
                }
